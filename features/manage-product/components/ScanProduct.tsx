import { ProductInfo } from "@/pages/api/inbound/product-info";
import { InventoryMethod } from "@/pages/api/products/create";
import { assignedProducts, BoxSize, ProductQuality } from "@prisma/client";
...
export default function ScanProduct() {
  ...
  return (
    <section className="h-full w-full rounded-lg bg-white">
