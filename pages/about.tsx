...
export default function About({ data }: any) {
  return (
    <>
      ...
      <Layout>
        <div className="rounded-md p-6 bg-white shadow-md justify-center items-center gap-16 flex border border-black">
       ...
       />
          ...
          <section className={`w-1/2 flex justify-center item-center flex-col gap-5`}>
            ...
            <p className={" text-black leading-relaxed   font-roboto"}>
              ...
              <strong className="text-3xl text-yellow-400">ProStock</strong>! We are a team of experienced professionals
          ...
          and develop strategies that deliver results.`}
            ...
            <p className={"text-black leading-relaxed  "}>
              <strong className="text-3xl text-yellow-400">O</strong>ur team has a wealth of experience in a variety of industries and
              can help you navigate complex challenges and capitalize on new
              opportunities. From project management to financial planning and
              analysis, we have the expertise you need to succeed.
            </p>
